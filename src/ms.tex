...
numerical analysis functionality like \package{numpy} \citep{todo} and
\package{scipy} \citep{todo}, visualization frameworks like \package{matplotlib}
\citep{todo}, machine learning and data analysis packages like
\package{tensorflow} \citep{todo}, \package{pymc3} \citep{todo}, and
\package{emcee} \citep{todo}, domain-specific libraries like \package{yt}
\citep{todo}, \package{plasmapy} \citep{todo}, \package{sunpy} \citep{todo},
\package{Biopython} \citep{todo}, and \package{sympy} \citep{sympy} (to name a
