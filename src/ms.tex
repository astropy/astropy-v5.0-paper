...
\begin{description}
  ...
  While \astropy is used globally --- TODO figure with analytics --- our user
  community is underrepresented in non-English-speaking or -teaching countries
  and our maintainers and coordinators are fairly narrowly concentrated in the
