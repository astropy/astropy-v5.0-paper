...
Study program, which supported the grant ``Linking CASA to the astropy ecosystem''\foontnote{\url{https://science.nrao.edu/facilities/alma/science_sustainability/Spectral_Cube_and_Radio_Beam_Ginsburg.pdf}}.
...
overhaul. The package \texttt{gammapy} \citep{gammapy} has major performance
