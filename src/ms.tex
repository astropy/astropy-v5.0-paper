...
\begin{figure}
    \begin{centering}
      \includegraphics{figures/commits_committers_per_month.pdf}
        \caption{
            \todo{Adrian}{Write caption@}
        }
        \label{fig:contributor-summary:commits_committers_per_month}
    \end{centering}
\end{figure}

\begin{figure*}
    \begin{centering}
      \includegraphics{figures/Ncommitters_vs_frac_commits.pdf}
        \caption{
            \todo{Adrian}{Write caption@}
        }
        \label{fig:contributor-summary:Ncommitters_vs_frac_commits}
    \end{centering}
\end{figure*}

\begin{figure*}
    \begin{centering}
      \includegraphics{figures/top_contributors_career.pdf}
        \caption{
            \todo{Adrian}{Write caption@}
        }
        \label{fig:contributor-summary:top_contributors_career}
    \end{centering}
\end{figure*}
