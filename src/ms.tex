...
\package{scipy} \citep{todo}, to visualization frameworks like
\package{matplotlib} \citep{todo}, to machine learning and data analysis
packages like \package{tensorflow} \citep{todo}, \package{pymc3} \citep{todo},
and \package{emcee} \citep{todo}, to specialized, domain-specific packages like
\package{yt} \citep{todo}, \package{plasmapy} \citep{todo}, \package{sunpy}
\citep{todo}, \package{Biopython} \citep{todo}, and \package{sympy}
