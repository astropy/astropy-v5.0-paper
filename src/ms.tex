...
long been missing and as part of this year's Google Summer of Code project
\href{https://docs.astropy.org/en/stable/io/ascii/write.html#cds-mrt-format}{MRT}
has been added to the \astropyTable\ I/O. In addition, \astropyTable\ may also read from and write
...
standard} has been updated to version 1.0, adding support for three additional data
...
of the hosted data and services. For example, the AAT Archive hosts date back to
...
open-source projects. While the Slack and Astropy-dev mailing lists are primarily used to discuss the project direction and updates, it was noted that the use of a Facebook community could present a barrier to open source. The Astropy Project identified a need for a public, archived, searchable, and easy-to-navigate interface for users to ask for help. Accordingly, we have commissioned
