...
All Astropy-coordinated and other affiliated packages are listed on the astropy
website.\footnote{\url{https://www.astropy.org/affiliated}}
...
\todo{APW}{Add a table of all affiliated packages, like in the previous paper}
