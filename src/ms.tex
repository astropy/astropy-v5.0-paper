...
\begin{figure}[ht]
    \begin{centering}
      \includegraphics[width=0.8\textwidth]{Ncommitters_vs_frac_commits.pdf}
        \caption{
            todo
        }
...
case in many large, open-source software communities \citep[e.g.,][]{numpy}.

As an example of this effect within the \astropy Project, here we focus on
...
commits, separated into three separate ``eras'' in the history of the
Project.\footnote{Note, however, that measuring these statistics in terms of Git
commits is not a perfect way of encapsulating ``effort,'' but we use this metric
for its simplicity and clear definition.}
...
majority of the work in \astropypkg is done my a small subset of the
contributors.
...
\begin{figure}[ht]
    \begin{centering}
      \includegraphics[width=0.5\textwidth]{commits_committers_per_month.pdf}
        \caption{
            todo
        }
