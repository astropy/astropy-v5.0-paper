...
packages developed to enable specific research subdomains like
...
\begin{description}
  ...
  but we therefore have significant amounts of critical infrastructure or core
  ...
  Within the core package, a prime example is the \astropyfits subpackage, which
  ...
  But also the specialized nature of the software requires being able to hire or
  ...
  These challenges will require cultural and larger systemic changes to
  ...
  Astropy is
  Practical issues: translation of content and documentation, github is not accessible in some countries.
  \item[Long-term / sustained funding for maintaining infrastructure] Software
  and packaging infrastructure includes but not limited to Continuous
  Integration (CI), test plugins, documentation builds, and package delivery.
  Keeping the infrastructure working is essential in software development and
  operations. This kind of work has low visibility and is not attractive to
  scientists or volunteer contributors; therefore, it is most effective to
  delegate such tasks to paid roles. \astropy secured a three-year grant for
  this but the situation remains uncertain once the grant runs out, as
  infrastructure evolves and requires constant maintenance and upgrades. Some of
  the engineers currently in these roles are also employees of research
