...
\subsubsection*{Interoperability} \label{sec:core-features-interoperability}
  ...
  \paragraph{Table Mixin Columns}
    ...
    % TODO: this is very rough. Probably needs a bit of a re-write.
    ...
    used to provide the seamless integration of \package{dask} arrays in
    \astropyTable, allowing computer cluster-scale data to be stored in a
    \astropyTable.

  \paragraph{Astropy Fits in Time}
    % TODO! maybe merge with previous section
  ...
  \paragraph{Persistent Storage and I/O}
    ...
    % TODO! need good transition sentence. This one is bad.
