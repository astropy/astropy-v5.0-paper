...
- Astropy is established; challenges faced have evolved
-

\begin{itemize}
\item Attracting new contributors when the code has become quite complex, project established (astropy as an "institution", walled-off group). (how to attract? Fast feedback and code reviews, ...)
\item Support for existing contributors: Contributor and maintainer mentoring (...)
\item Infrastructure: Long-term / sustained funding for maintaining infrastructure (grants last 3 years; infrastructure evolves, nature of open source ecosystem)
\item As ecosystem grows, making sure users know about all of the functionality (workshops, tutorials, educational materials, discoverability, accessibility) (Continued engagement with user community)
\end{itemize}
