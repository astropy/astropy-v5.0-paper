...
interest about open-source software tools is leading a paradigm shift in the way
research is done, data is analyzed, and results are shared.


TODO:  https://physicsworld.com/a/standing-on-the-shoulders-of-programmers/

A major reason that Python has been adopted in the sciences is the huge amount
of community-oriented, open-source software tools that are available to
anyone...TODO.
TODO: Numpy, scipy, matplotlib, scientific software ecosystem.
In astronomy, one of the first large, community-oriented, open-source \python packages ... was Astropy ... (note: yt)
