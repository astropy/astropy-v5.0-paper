    ...
    \begin{centering}
      \includegraphics[width=0.75\textwidth]{commits_committers_per_month.pdf}
        \caption{
            ...
            v5.0).
            The number clearly peaks just before feature freezes (vertical
            ...
            commits per month.
            \textbf{Bottom panel:} The number of unique Git committers who
            contribute to the \astropypkg core package each month (again defined
            as consecutive 30 day windows).
...
A final metric we consider ... rate of contributions and contributor participation ...
