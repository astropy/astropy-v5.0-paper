...
including connections with several observatories and missions.
We also revisit the future outlook of the \astropy Project and the current
status of Learn Astropy. Last but not least, we contemplate the current
and future challenges facing the project.
\end{abstract}
