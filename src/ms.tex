...
This committee overlooks the planning and disbursement of finances on behalf
...
the fiscal sponsor of the project. Previously, no direct financial support
was available for the project development, and NUMFOCUS covered the incurred
operational costs. However, transitioning to long-term financial stability meant
having an influx of funds in the form of institutional support \citep{2016arXiv161003159M},
and hence the Astropy project applied for and successfully acquired several grants.
The two major ones are briefly summarized below.

\begin{itemize}
    \item Moore: The Gordon and Betty Moore Foundation awarded the Astropy
    project a \$900,000 grant in 2019 for the proposal ``Sustaining and Growing
    the Astropy Project". Over a three-year term, this grant supported sustenance
    of the project by providing funds for (1) the development and maintenance of
    the \astropypkg and its infrastructure to existing project members and
    targeted hires, (2) the transition of long-term users to contributors and
    maintainers through mentorship efforts, (3) the formalization of a governance
    structure (see \S \ref{sec:project-governance}), and (4) the improvement
    of equity, diversity, and inclusion efforts in the project (see \S
    ...
    \item NASA: A successful proposal to the NASA ROSES-2020 call, section E.7
    (Support for Open Source Tools, Frameworks, and Libraries), provided the
    Astropy project \$634,590 to support its work. Funded work for a term of
    three years includes (1) project-wide infrastructure maintenance and
...
which funded development work to support both the Astropy and DRAGONS
projects. The project also received a total of CAD 31,023 from the Dunlap
